             ...
             dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    ...
    if ((self = [super init]))
    {
        ...
        NSString *privateQueueName = [NSString stringWithFormat:@"com.cc.CCWeakTimer.%p", self];
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    CCWeakTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
...
- (void)schedule
{
    ...
    __weak CCWeakTimer *weakSelf = self;
